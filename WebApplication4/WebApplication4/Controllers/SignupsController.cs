...
namespace WebApplication4.Controllers
{
    public class SignupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "sig_id,sig_username,sig_Name,sig_fname,sig_Gender,sig_Email")] Signup signup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "sig_id,sig_username,sig_Name,sig_fname,sig_Gender,sig_Email")] Signup signup)
        {
            if (ModelState.IsValid)
            {
